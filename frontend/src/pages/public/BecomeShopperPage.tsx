...
const BENEFITS = [
  { icon: '🕐', title: 'Flexible work', body: 'Go online when you want, offline when you don\u2019t. No shifts, no minimums.' },
  { icon: '📍', title: 'Choose your area', body: 'Set the markets and neighborhoods you know best.' },
  { icon: '🔔', title: 'Accept nearby jobs', body: 'See requests close to you first, with the item, budget and estimated fee up front.' },
  { icon: '🛍️', title: 'Shop for customers', body: 'Use your knowledge of the market to find exactly what they asked for.' },
  { icon: '💰', title: 'Earn service fees', body: 'Keep your shopping fee and delivery fee — paid out transparently after every completed job.' },
  { icon: '⭐', title: 'Build your reputation', body: 'Every completed job builds your rating and unlocks more requests.' },
];
    ...
    <div className="mx-auto max-w-5xl px-4 py-16">
      <div className="text-center">
        ...
        <Link to="/register?role=shopper" className="mt-8 inline-block">
          <GlassButton size="lg">Become a shopper →</GlassButton>
        </Link>
      </div>
      ...
      <div className="mt-16 grid gap-5 md:grid-cols-3">
        {BENEFITS.map((b) => (
          <GlassCard key={b.title}>
            <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-green-mist text-xl">{b.icon}</span>
