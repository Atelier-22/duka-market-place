/**
 * Small brand visual for the auth forms: a market, a dotted route, a home,
 * and the Duka bag travelling between them. Pure SVG, brand tokens only.
 */
