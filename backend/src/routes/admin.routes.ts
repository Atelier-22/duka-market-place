...
import * as intelligence from '../knowledge/intelligenceAdmin.controller';
...
router.post('/knowledge/products/:id/research', asyncHandler(intelligence.requestResearch));
router.get('/knowledge/corrections', asyncHandler(intelligence.corrections));
router.post('/knowledge/corrections/:id/:action', asyncHandler(intelligence.decideCorrection));
router.get('/knowledge/quality', asyncHandler(intelligence.dataQuality));
router.get('/knowledge/research/extract', asyncHandler(intelligence.extractPreview));
