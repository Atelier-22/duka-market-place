...
export const APPLE_COLOURS: Swatch[] = [
...
export const SAMSUNG_COLOURS: Swatch[] = [
...
export const ANDROID_COLOURS: Swatch[] = [
...
export const WOOD_COLOURS: Swatch[] = [
...
export const BRAND_COLOURS: { match: RegExp; title: string; colours: Swatch[] }[] = [
