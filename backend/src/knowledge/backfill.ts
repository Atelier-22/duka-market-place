...
import { seedCanonicalCatalogue, seedCatalogueDetails } from './lifecycle';
...
async function main() {
  ...
  console.log(`catalogue details: ${details.products} products, ${details.specs} specs, ${details.variants} variants`);
